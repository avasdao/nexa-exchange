...
<template>
    <main class="hidden h-screen lg:flex flex-col justify-between items-center bg-gradient-to-b from-amber-200 to-white">
        <img
            alt="Nexa Swap Logo"
        ...
        <div class="w-3/4">
            <h1 class="text-7xl font-bold uppercase bg-gradient-to-r from-amber-400 to-amber-900 bg-clip-text text-transparent">
                Nexa
            </h1>

            <h1 class="text-9xl font-bold bg-gradient-to-r from-indigo-400 to-gray-600 bg-clip-text text-transparent">
                Swap
            </h1>
            ...
            <section class="w-full mt-3 px-5 py-2 bg-gray-800 rounded-md">
                ...
                <div class="flex justify-end">
                    <span class="text-yellow-400 font-medium text-2xl">
                        <span class="">
                            {{System.displayPctChg24h}}
                        </span>

                        <svg v-if="System.displayPctChg24h[0] === '-'" class="inline w-6 h-6 text-red-400" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 13.5L12 21m0 0l-7.5-7.5M12 21V3"></path>
                        </svg>
                        <svg v-else class="inline w-6 h-6 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
