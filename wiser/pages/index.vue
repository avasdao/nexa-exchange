            ...
            <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                <div class="flex lg:flex-1">
                    <a href="#" class="-m-1.5 p-1.5">
                        ...
                        <img class="h-14 w-auto" src="~/assets/nexa.svg" alt="" />
                    </a>
                </div>
                ...
                <div class="hidden lg:flex lg:gap-x-12">
                    <NuxtLink to="/swap" class="text-lg font-semibold leading-6 text-gray-900">
                        Swap
                    </NuxtLink>

                    <NuxtLink to="/tokens" class="text-lg font-semibold leading-6 text-gray-900">
                        Tokens
                    </NuxtLink>

                    <NuxtLink to="/nfts" class="text-lg font-semibold leading-6 text-gray-900">
                        NFTs
                    </NuxtLink>

                    <NuxtLink to="/pools" class="text-lg font-semibold leading-6 text-gray-900">
                        Pools
                    </NuxtLink>
                </div>
                <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                    <NuxtLink to="https://nexa.exchange" target="_blank" class="text-lg font-semibold leading-6 text-gray-900">
                        <small class="block text-xs text-rose-500 font-normal">Looking for PRO tools?</small>

                        <div class="flex flex-row items-center gap-1">
                            open NEXA.exchange
                            <svg class="w-4 h-auto text-rose-500 font-normal" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <footer class="mt-32 bg-gray-900 sm:mt-56" aria-labelledby="footer-heading">
            ...
            <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
                ...
                <div class="mt-8 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
                    ...
                    <p class="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">&copy; 2020 WiserSwap, Inc. All rights reserved.</p>
                </div>
            </div>
        </footer>
    </div>
