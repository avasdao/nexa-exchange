...
<template>
    <main class="w-full mx-auto mt-5 px-5">
        <header class="w-full px-3 flex justify-between">
            ...
            <svg @click="isShowingSettings = true" class="w-7 h-auto text-sky-100 cursor-pointer hover:text-sky-600" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
