...
async function tvl({ timestamp }) {
    ...
    const { data } = await axios.get(`https://nexa.exchange/v1/wiserswap/tvl/${timestamp}`)

    // Every token pair is matched with NEXA.
    // We collect total value locked on the NEXA side of the contract.
    ...
    return {
        ...
        'nexa': Number(total_sats / 100000000n),
    }
}
